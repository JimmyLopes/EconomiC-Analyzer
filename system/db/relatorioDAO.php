...
require_once (dirname(__FILE__) . '\..\classes\beneficiario.php');

class relatorioDAO
{
    public function rela1()
    {
        global $pdo;
        try {
